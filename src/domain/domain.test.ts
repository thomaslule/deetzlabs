...
describe("Domain", () => {
  ...
  test("after muting, should not send messages in chat", async () => {
    const storage = new PgStorage(db);
    const sendChatMessage = jest.fn();
    const domain = new Domain(storage, sendChatMessage, () => {}, testOptions);
  ...
  test("after muting, achievements should not be shown", async () => {
    const storage = new PgStorage(db);
    const sendChatMessage = jest.fn();
    const domain = new Domain(storage, sendChatMessage, () => {}, testOptions);
  ...
  test("after unmuting, should send messages in chat", async () => {
    const storage = new PgStorage(db);
    const sendChatMessage = jest.fn();
    const domain = new Domain(storage, sendChatMessage, () => {}, testOptions);
