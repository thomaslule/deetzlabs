...
describe("ViewersProjection", () => {
  ...
  test("migrate-data events should update the achievements view", async () => {
    ...
    await proj.handleEvent(makeViewerEvent({
      type: "migrated-data",
      achievements: [
    ...
    expect(stored).toEqual([
      { achievement: "cheerleader", viewerId: "123", viewerName: "Someone", date: cheerleaderDate },
      { achievement: "supporter", viewerId: "123", viewerName: "Someone", date: supporterDate },
    ]);
  });
